    ...
    return Positioned.fill(
      child: GestureDetector(
        ...
        child: _imageLoaded && _stencilImage != null
            ...
            : Container(), // 載入中不顯示任何東西
      ),
    );
  }
}

class _StencilImagePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final srcRect = Rect.fromLTWH(
      0, 0,
      stencilImage.width.toDouble(),
      stencilImage.height.toDouble(),
    );
    ...
    canvas.drawImageRect(stencilImage, srcRect, dstRect, Paint());

    canvas.restore();
  }

  @override
  bool shouldRepaint(covariant _StencilImagePainter oldDelegate) {
